...
template <class T>
KolibriLib::point<T> &KolibriLib::point<T>::operator+(const KolibriLib::point<T> &a)
{
    x += a.x;
    y += a.y;
    return *this;
...
template <class T>
KolibriLib::point<T> &KolibriLib::point<T>::operator=(const KolibriLib::point<T> &p)
{
    x = p.x;
    y = p.y;
    return *this;
...
template <class T>
KolibriLib::point<T> &KolibriLib::point<T>::operator+=(const T &p)
{
    x += p;
    y += p;
    return *this;
...
template <class T>
bool KolibriLib::point<T>::operator==(const KolibriLib::point<T> &a) const
{
    return x == a.x && y == a.y;
}
